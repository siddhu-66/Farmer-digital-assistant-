import { Sprout, CloudSun, ShoppingBag, User, LayoutDashboard, Recycle, BrainCircuit, ShieldCheck, Building2, FileCheck, Activity, PlusCircle, BarChart3, Truck, Settings, Users, ClipboardList, Package
} from 'lucide-react';
